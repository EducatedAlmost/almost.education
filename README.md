...
* [`src/ae/almost_education/styles.cljs`](src/ae/almost_education/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/ae/almost_education/`](src/ae/almost_education/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/ae/almost_education/core.cljs): contains the SPA entry point, `init`
* [`test/ae/almost_education/`](test/ae/almost_education/): test files (ClojureScript,
...
(headless test environment)
    * For Chromium, set the `CHROME_BIN` environment variable in your shell to the command that
    launches Chromium. For example, in Ubuntu, add the following line to your `.bashrc`:
       ...
       ```
5. Clone this repo and open a terminal in the `ae/almost-education` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/ae/almost_education/config.cljs) defaults to `true` in
